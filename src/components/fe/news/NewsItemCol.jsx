...
const NewsItemCol = ({item, url})=>{
    return <a href={`/category/${url ? url : 'tin-tuc'}/${createUrlFriendly(item?.name+"-"+item["_id"])}`} className={'flex flex-col items-center gap-[10px] px-[10px] pb-[30px] cursor-pointer'}>
