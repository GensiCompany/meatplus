...
import manageDiscountsApi from "@/app/api/cms/managePromotionApi";
...
const CreatePromotionModal = ({ setIsShowCreateModal, isShowCreateModal,refresh }) => {
    ...
    const createBanner = async(values)=>{
        try{
            if(!content){
                ...
                setIsLoading(true);
                const res=await manageDiscountsApi.createDiscounts({...values,content:content,retreasts:[values?.retreasts]});
    ...
    return (
        ...
        >
            ...
            <Spin spinning={isLoading}>
                <Formik
                    initialValues={{ imageUrl: null, name:"",shortDescription:"",retreasts:""}}
