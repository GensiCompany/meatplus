...
const CreateLocationModal = ({ setIsShowCreateModal, isShowCreateModal,refresh, total }) => {
    ...
    const handleOk = async (values) => {
        try{
            setIsLoading(true);
            const res=await manageLocationApi.createLocation({...values,order:total})
    ...
    return (
        ...
        >
            ...
            <Spin spinning={isLoading}>
                <Formik
                    initialValues={{name:"", address:"",email:"",facebook_link:"",phoneNumber:"",imageUrl:"",map:"",lat:"",lng:""}}
